...
BOOL setKeyAndValue(const WCHAR* szKey,         // const char* szKey
	const WCHAR* szSubkey,                      // const char* szSubkey,
	const WCHAR* szValue);                      // const char* szValue

void CLSIDtochar(const CLSID& clsid,            // Convert a CLSID into a char string.
	WCHAR* szCLSID,                             // char* szCLSID,
	int length);
